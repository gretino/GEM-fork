...
class LlavaMetaModel:
    ...
    def initialize_ecg_modules(self, model_args, fsdp=None):
        ...
        pretrain_ecg_projector = model_args.pretrain_ecg_projector
        ...
        self.config.ecg_projector_type = getattr(model_args, 'ecg_projector_type', 'linear')
        ...
        if pretrain_ecg_projector is not None:
            ...
            self.ecg_projector.load_state_dict(get_w(ecg_projector_weights, 'ecg_projector'))
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_ecgs(self, ecgs):
        ...
        ecg_features = self.get_model().ecg_projector(ecg_features)
    ...
    def prepare_inputs_labels_for_multimodal(
        self, input_ids, position_ids, attention_mask, past_key_values, labels, ecgs,
