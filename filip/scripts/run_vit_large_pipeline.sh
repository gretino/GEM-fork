...
NUM_GPUS=${#GPUS[@]}
echo "========================================================================"
echo "Multi-GPU Execution Enabled: Using ${NUM_GPUS} GPUs [${GPUS[*]}]"
echo "========================================================================"

STAGE1_CKPT="outputs/filip/mimic_report_alignment_vit_large_pretrain/checkpoints/best.pt"
...
if [[ "$SKIP_STAGE1" == "1" ]] || [[ -f "$STAGE1_CKPT" ]]; then
    ...
    echo "========================================================================"
    echo "Stage 1: Pretraining ViT-Large Backbone on MIMIC-IV-ECG (15 Epochs)..."
    echo "========================================================================"
    CUDA_VISIBLE_DEVICES=${GPUS[0]} $PYTHON filip/train/train_mimic_feature.py --config filip/configs/mimic_report_alignment_vit_large_pretrain.yaml
fi

echo "========================================================================"
echo "Stage 2: Parallel ViT-Large Adaptation across 6 Benchmark Datasets..."
echo "========================================================================"

CONFIGS=(
  "filip/configs/report_alignment_adapt_vit_large/ptbxl_super_adapt.yaml"
  "filip/configs/report_alignment_adapt_vit_large/ptbxl_sub_adapt.yaml"
  "filip/configs/report_alignment_adapt_vit_large/ptbxl_rhythm_adapt.yaml"
  "filip/configs/report_alignment_adapt_vit_large/ptbxl_form_adapt.yaml"
  "filip/configs/report_alignment_adapt_vit_large/cpsc_adapt.yaml"
  "filip/configs/report_alignment_adapt_vit_large/csn_adapt.yaml"
)
...
echo "========================================================================"
echo "Stage 3: Generating 3-Way Comparative Benchmark Summary Report..."
echo "========================================================================"
$PYTHON filip/scripts/generate_summary.py

echo "Pipeline completed successfully across all GPUs!"
